                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return '<div class="btn-group" role="group" aria-label="Users Actions">' +
                                ...
                                row.id + '" onclick="duplicateUsers(' + row.id +
                                ')"><i class="fa-solid fa-copy"></i></button>' +
                                '<button class="btn btn-sm btn-edit btn-warning" title="Edit Data" data-id="' +
                                row
                                .id + '" onclick="editUsers(' + row.id +
                                ')"><i class="fa-solid fa-pencil"></i></button>' +
                                '<button class="btn btn-sm btn-delete btn-danger" title="Delete Data" onclick="deleteUsers(' +
            ...
            $('#saveProductBtn').on('click', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#usersTable').DataTable().ajax.reload(); // Reload the table data
    ...
    <div class="container-fluid px-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table id="usersTable" class="table table-striped table-hover table-responsive" style="width: 100%">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Name</th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-sm btn-secondary" id="saveProductBtn">Save Product</button>
                </div>
            </div>
        </div>
    </div>
